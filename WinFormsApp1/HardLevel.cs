...
namespace GameProjectOop
{
    public partial class HardLevel : Form
    {
        ...
        string facing = "up";
        int playerLives = 3;
        int zombieSpeed = 6; // Harder speed (Moderate was 4)
        int score = 0;
        ...
        void SpawnMind()
        {
            ...
            ChaseMovement chase = new ChaseMovement(player, 5.5f); // Faster boss movement (Moderate was 4.5)
            ...
            {
                float bulletSpeed = 8f; // Faster enemy bullets (Moderate was 6)
